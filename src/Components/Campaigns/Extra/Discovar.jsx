...
function Discovar() {
  return (
    <div className='grid md:grid-cols-12 max-w-7xl mx-auto items-center p-5'>
      <div className='md:col-span-7'>
   
      <Fade>
      <h1 className='text-[#fb944f] font-bold'><Typewriter
            words={['READY TO GO --']}
            loop={Infinity} 
            cursor
            cursorStyle="_"
...
<Fade>
  <h1 className='font-bold text-[#de7835] text-2xl md:text-3xl lg:text-4xl my-4 md:my-7'>Why You Should Choose PlanMake Platform
      </h1>
</Fade>
     ...
     <div className='md:flex gap-x-2  border-2 rounded-xl py-5'>
        ...
        <h1 className='text-6xl text-[#da7568] '><GiTrophyCup /></h1>
        </div>
        <div>
      ...
      <div  className='md:flex gap-x-2  border-2 rounded-xl py-5'>
        ...
        <h1 className='text-6xl text-[#da7568] '><LiaSortNumericUpSolid /></h1>
        </div>
        <div>
...
<h1 className='text-[300px] text-[#fb944f]'>      <GiTrophyCup /></h1>
      </div>
